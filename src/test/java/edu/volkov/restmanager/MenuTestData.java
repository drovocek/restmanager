...
public class MenuTestData {
    ...
    public final static LocalDate tomorrow = LocalDate.of(2020, 1, 28);
    ...
    public static final List<Menu> menus = Arrays.asList(menu1, menu2, menu3, menu4, menu5, menu6, menu7, menu8, menu9, menu10, menu11);
