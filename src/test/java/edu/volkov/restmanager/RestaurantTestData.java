...
public class RestaurantTestData {
    ...
    public static final Restaurant rest3 = new Restaurant(REST1_ID + 2, "rest3", "address3", "+7 (933) 333-3333", false, 1);
    public static final Restaurant rest4 = new Restaurant(REST1_ID + 3, "rest4", "address4", "+7 (944) 444-4444", true, 2);
    public static final Restaurant rest5 = new Restaurant(REST1_ID + 4, "rest5", "address5", "+7 (955) 555-5555", false, 1);
    public static final Restaurant duplicateNameRest = new Restaurant(null, "rest1", "address2", "+7 (966) 666-6666", true, 0);
    public static final List<Restaurant> allRestaurants = Arrays.asList(rest1, rest2, rest3, rest4, rest5);
    public static final List<Restaurant> allEnabledRestaurants = Arrays.asList(rest1, rest2, rest4);
